...
<div align="center">
<p>
<button type="button" name="indietro" onclick="vendi()">Vendi</button>
...
<script>
	function vendi(){
		window.location.assign("vendi.php");	
	}
</script>
<script>
var xhr;
...
xhr.open("GET","visualizzafilmadmincontroller.php?id=<?php echo $_GET["id"] ?>",true);
xhr.send("");
}
function carica(){
