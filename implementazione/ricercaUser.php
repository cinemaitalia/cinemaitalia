...
if ($cont %2 == 0){
	...
	echo $riga[3]."</td><td>".$riga[4]."</td><td>".$riga[5]."</td><td><a href='visualizzafilmuser.php?id=".$riga[0]."'><button type='button'>Visualizza</button></a></td></tr>";
	$cont ++;
	}
else {
...
<script>
function annulla(){
document.location.assign("homepageuser.php");
}
</script>
