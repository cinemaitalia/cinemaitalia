...
<div align="center">
<p>
<button type="button" name="indietro" onclick="prenota()"> Prenota </button>
...
<script>
	function prenota(){
		window.location.assign("prenota.php");	
	}
</script>
<script>
var xhr;
...
xhr.open("GET","visualizzafilmusercontroller.php?id=<?php echo $_GET["id"] ?>",true);
xhr.send("");
}
function carica(){
